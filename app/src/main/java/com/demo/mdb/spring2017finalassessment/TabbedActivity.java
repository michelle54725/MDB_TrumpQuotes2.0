...
public class TabbedActivity extends AppCompatActivity {
    ...
    public static class ScoresFragment extends Fragment {
        ...
        @Override
        public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
            mRecyclerView = findViewById(R.id.scoresRecyclerView);
            mLinearLayoutManager = new LinearLayoutManager(this);
            mRecyclerView.setLayoutManager(mLinearLayoutManager);
            mRecyclerView.setAdapter(new ScoresAdapter(this, myRef.child(mAuth.getUid().toString()).child("games")));
        ...
        public Fragment getItem(int position) {
            ...
            switch (position) {
                case 0: // Fragment # 0 - This will show FirstFragment
                    return PlayFragment.instantiate(TabbedActivity.this, "SECTION 1");
                case 1: // Fragment # 0 - This will show FirstFragment different title
                    return ScoresFragment.instantiate(TabbedActivity.this, "SECTION 2");
                default:
                    return null;
            }
        }
...
//            return inflater.inflate(R.layout.placeholder, container, false);
            return null; //TODO: placeholder xml?
        }
